    ...
    var pokemonImageView : UIImageView = {
        ...
        func setUpView() {
            ...
            NSLayoutConstraint.activate([
                ...
                pokemonName.leadingAnchor.constraint(equalTo: pokemonImageView.trailingAnchor, constant: 18),
                pokemonName.trailingAnchor.constraint(equalTo: trailingAnchor, constant: -12),
                pokemonName.topAnchor.constraint(equalTo: pokemonImageView.topAnchor, constant: 24)
